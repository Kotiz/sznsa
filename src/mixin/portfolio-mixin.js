      ...
      return {
         portfolioItems:  [
            //  v1
             {
                 id: 1,
                 img: require(`@/assets/images/gallery/img_01.jpg`),
                 title:'The Gang Blue',
             ...
             {
                 id: 2,
                 img: require(`@/assets/images/gallery/img_02.jpg`),
             ...
             {
                 id: 3,
                 img: require(`@/assets/images/gallery/img_03.jpg`),
             ...
             {
                 id: 4,
                 img: require(`@/assets/images/gallery/img_04.jpg`),
             ...
             {
                 id: 5,
                 img: require(`@/assets/images/gallery/img_05.jpg`),
             ...
             {
                 id: 6,
                 img: require(`@/assets/images/gallery/img_06.jpg`),
             ...
             {
                 id: 7,
                 img: require(`@/assets/images/gallery/img_07.jpg`),
             ...
             {
                 id: 8,
                 img: require(`@/assets/images/gallery/img_08.jpg`),
