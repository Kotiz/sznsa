        ...
        <div class="container">
          <div class="text-center row">
            <div class="col-xl-9 m-auto">
              <h1 class="heading" v-html="service.title"></h1>
              <p class="sub-heading space-xs font-gordita mt-15">
                {{service.subtitle ? service.subtitle : 'We are a creative company that focuses on establishing long-term relationships with customers.'}}
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-xl-9 col-lg-8 order-lg-last">
            <div class="details-wrapper ps-xl-5">
              ...
              <p class="pt-40 pb-40">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas interdum, orci at dapibus, massa ante pharetra tellus. Maecenas interdum, orci at euismod dapibus. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas interdum.</p>
              <div class="row">
                <div class="col-md-6">
...
export default {
  ...
  methods: {
    getService(serviceId) {
      this.service = this.services.find(item => item.id == serviceId);
    }
  },
  created() {
