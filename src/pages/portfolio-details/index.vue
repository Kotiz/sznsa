<template>
	<div class="main-page-wrapper overflow-hidden">
		...
		<div class="portfolio-details-one mt-75 mb-150 md-mb-100">
			<div class="container">
				...
				<div class="main-content mt-75">
					<img src="../../assets/images/gallery/img_33.jpg" alt="" class="mb-90 md-mb-50">
					<div class="row">
						<div class="col-xl-11 m-auto">
							<div class="row">
								...
								<div class="col-md-8 order-md-first">
									<h4>Overviw</h4>
									<p>Commonly used in the graphic, prit quis due & publishing indust for 
                    previewing lightly visual	mockups.</p>
									<h4>Task</h4>
									<p>Rebuild a unified visual system for the advertising agency, made of steel which can 
                    change theworld in a while.</p>
		...
		<FooterSeven :dark_bg="true" :dark_btn="true" />
	</div>
</template>

<script>
import Header from '@/components/common/Headers/Header.vue';
import FooterSeven from '@/components/common/Footers/FooterSeven.vue';
